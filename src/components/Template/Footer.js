    ...
    <footer>
      <div className="footer">
        <div className="company-menu">
          ...
          <div>
            <a href="https://www.instagram.com/wantedjobs.kr/" className="sns-link" aria-label="" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.youtube.com/channel/UC0tGZ6MqieGG2m5lA5PeQsw" className="sns-link" aria-label="" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.facebook.com/wantedkr" className="sns-link" aria-label="" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://blog.naver.com/wantedlab" className="sns-link" aria-label="" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://pf.kakao.com/_XqCIxl" className="sns-link" aria-label="" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://post.naver.com/my.nhn?memberNo=18284175" className="sns-link" aria-label="" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://apps.apple.com/kr/app/id1074569961" className="sns-link" aria-label="sns-link" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://play.google.com/store/apps/details?id=com.wanted.android.wanted" className="sns-link" aria-label="" target="_blank" rel="noopener noreferrer">
        ...
        <div id="companyInfo">
          <p id="footerText">
            ...
            <br /> 유료직업소개사업등록번호 : (국내) 제2020-3230259-14-5-00018호 | (국외) 서울동부-유-2020-2 | 사업자등록번호 : 299-86-00021 | 02-539-7118 © Wantedlab, Inc.
          </p>
