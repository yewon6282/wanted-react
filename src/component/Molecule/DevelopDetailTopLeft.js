  ...
  return (
    <div>
        ...
        <div className="develop-detail-middle">
          <span className="develop-detail-category">프론트엔드 개발</span>
          <div className="develop-detail-company">
            <span className="develop-detail-company-name">카카오픽코마</span>
            <div className="develop-job-card-hover">
              <div className="develop-job-card">응답률 높음</div>
              <span className="develop-job-card-massage">지원 후 응답받을 확률이 95% 이상입니다.</span>
            </div>
            <div className="company-location">서울 · 한국</div>
          </div>
